  ...
  return (
    <div className="flex flex-col items-center px-8 pb-10 mt-10">
      ...
      <div className="flex flex-col items-center md:items-stretch  md:flex-row gap-5 mt-5 max-w-[1200px]">
        <div className=" flex-1 border-2 border-sky-500 rounded-md px-4 pt-2 md:pt-4 pb-4 md:pb-6 flex flex-col items-center max-w-[500px]  md:w-auto h-full">
          <img />
        ...
        <div className="flex-1  border-2 border-sky-500 rounded-md px-4 pt-2 md:pt-4 pb-4 md:pb-6 flex flex-col items-center max-w-[500px]  md:w-auto ">
          <img />
